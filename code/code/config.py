...
class cfg():
    ...
    def get_args(self):
        ...
        parser.add_argument("--pretrain_path", default="/home/Zhouyu/MODEL/MolGen/moldata/finetune/zinc250k.csv", type=str, help="Pretrain path")
        parser.add_argument('--weight_decay', type=float, default=0.0001)

        parser.add_argument("--model_name", default="ChemGPT", type=str, choices=["ChemGPT"], help="model name")
        ...
        parser.add_argument('--prop_dim', type=int, default=1, help="dimension for propEncoder")
        parser.add_argument('--prop_num', type=int, default=4, help="number of property")
        parser.add_argument('--layers', type=int, default=4, help="number of GPTLayers")
